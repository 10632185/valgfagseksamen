  ...
  <?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="card">
      ...
      <div class="card-header">
        <?php echo get_avatar( get_the_author_meta('ID'), 50, '', '', array('class' => 'profile-pic') ); ?>
        <div class="user-info">
      ...
      <!-- Comments -->
      <div class="comments">
        <a href="<?php the_permalink(); ?>">View all comments...</a>
      </div>
